...
-- Schema alan
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `alan` DEFAULT CHARACTER SET utf8 ;
USE `alan` ;
...
CREATE TABLE IF NOT EXISTS `alan`.`advert_group` (
  ...
  `pause_time` DATETIME NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `alan`.`developer` (
  ...
  `sso_id` VARCHAR(15) NOT NULL COMMENT '',
  `sso_name` VARCHAR(45) NOT NULL COMMENT '',
...
-- Table `alan`.`key`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alan`.`key` (
...
CREATE TABLE IF NOT EXISTS `alan`.`customer` (
  ...
  `sso_id` VARCHAR(15) NOT NULL COMMENT '',
  `sso_name` VARCHAR(64) NOT NULL COMMENT '',
